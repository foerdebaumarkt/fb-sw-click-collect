...
class Migration202510240100ReadyMailTemplate extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        if (!$typeId) {
            ...
            $connection->insert('mail_template_type', [
                'id' => $typeId,
                'technical_name' => 'foerde_click_collect.ready',
        ...
        if (!$templateId) {
            ...
            if (is_string($templateId) && Uuid::isHex($templateId)) {
